...
export class HomePage implements OnInit {
  ...
  constructor(public dataService: ChecklistDataService, private alertCtrl: AlertController, private storage: Storage, private navCtrl: NavController) { }
  ...
  addChecklist(): void {
    this.alertCtrl.create({
      ...
      message: 'Enter the name ofyour new checklist below:',
      inputs: [
        {
          type: "text",
          name: 'name'
